...
MQTT_TOPIC = "#"
#client setting
MQTT_CLIENT_ID = "historian-client" #name of this program to diclose to the broker
DB_FILE = "historian_data.db"

#MQTT client callback for connections - run once at the moment the client connects to the broker
def on_connect(client, userdata, flags, rc):
    print("Connected to MQTT")
    #good time to subscribe
    client.subscribe(MQTT_TOPIC)

#MQTT clien callback to handle incoming message
...
def save_to_database(topic, payload, timestamp):
    ...
    #make sure that there is a place where you can save the message to
...
#set callbacks
#on_connect as the actual callback to us upon connecting
...
##when messages come in. store them to a datbase
